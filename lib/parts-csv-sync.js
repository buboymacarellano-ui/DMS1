...
const HEADER_ALIASES = {
  ...
  generic: 'generic',
  supplier: 'supplier',
  receivingreceiptnumber: 'receiving_receipt_number',
  receiptno: 'receiving_receipt_number',
  receiptnumber: 'receiving_receipt_number',
  qty: 'qty',
  quantity: 'qty',
  onhand: 'on_hand',
...
function normalizeImportedRecord(raw, data, editor) {
  ...
  return {
    ...
    receiving_receipt_number: String(raw.receiving_receipt_number || '').trim(),
